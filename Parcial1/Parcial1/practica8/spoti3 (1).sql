...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2025 a las 01:20:04
...
CREATE TABLE `usuarios` (
  ...
  `membresia_id` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `membresia` (`membresia_id`);
